...
public class UpdateTimelineEntryRequest : ITimelineEntryValidationProperties
{
    public Guid Id { get; set; }

    // Core (DestinationId ve DayNumber değiştirilebilir)
    ...
    public OmniFlow.Domain.Enums.PlaceCategory? CustomCategory { get; set; }
    ...
    // Transport
    public OmniFlow.Domain.Enums.TransportMode? TransportType { get; set; }
